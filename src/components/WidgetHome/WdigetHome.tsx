...
const Avatar: React.FC<AvatarProps> = ({ agentAvatar, agentName, size = "md" }) => {
  ...
  return (
    <span className={cn(styles.avatar, size === "sm" && styles.avatarSm)} aria-hidden="true">
      {typeof agentAvatar === "string" ? (
        <img src={agentAvatar} alt="" className={styles.avatarImg} draggable={false} />
      ) : agentAvatar != null ? (
...
export const WidgetHome: React.FC<WidgetHomeProps> = memo(({
  ...
  const shouldShowHelp = showHelpArticles && helpArticles && helpArticles.length > 0;
    ...
    <div className={cn(styles.root, className)}>
      ...
      <div className={styles.header}>
        <div className={styles.headerTop}>
          {logo ? <LogoMark logo={logo} /> : <span className={styles.logoWrap} aria-hidden="true" />}
          <button
            type="button"
            ...
            {hasRecentMessage && (
              ...
              >
                ...
                <div className={styles.recentRow}>
                  <Avatar agentAvatar={agentAvatar} agentName={agentName} size="sm" />
                  <div className={styles.recentContent}>
                    <div className={styles.recentMeta}>
                      <span className={styles.recentName}>{agentName}</span>
                      {recentMessageTime && (
                        <span className={styles.recentTime}>{recentMessageTime}</span>
                      )}
                    </div>
